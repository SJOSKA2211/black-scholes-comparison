...
class TestRouters:
    ...
    def test_health_check(
        self, mock_get_supabase: Any, mock_get_minio: Any, mock_get_rmq: Any, mock_get_redis: Any
    ) -> None:
    ...
    def test_pricing_endpoint(self, mock_factory: Any, mock_get_supabase: Any) -> None:
        ...
        explicit_res = PriceResult(
            computed_price=10.45, method_type="explicit_fdm", exec_seconds=0.005
        )
