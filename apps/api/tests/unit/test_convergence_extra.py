...
class TestConvergenceExtra:
    def test_analyze_convergence_low_resolutions(self) -> None:
    ...
    def test_analyze_convergence_dt_resolution(self) -> None:
    ...
    def test_analyze_convergence_invalid_dt(self) -> None:
