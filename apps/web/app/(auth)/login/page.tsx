  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
      ...
      >
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 text-sm">
              Numerical methods for option pricing · MATH499
            </p>
          </div>
          ...
          {errorParam === "auth_failed" && (
            ...
            >
              ...
              <p>
                Authentication failed. Please ensure your Supabase keys in{" "}
                <code className="bg-red-500/20 px-1 rounded">.env.local</code>{" "}
                are valid and GitHub OAuth is configured.
              </p>
            </motion.div>
          )}
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900 px-4 text-slate-500 font-bold tracking-widest">
                Or Magic Link
              </span>
            </div>
          </div>
        ...
        >
          By continuing, you agree to the Research Platform&apos;s terms of
          service and methodology guidelines.
        </motion.p>
      </motion.div>
    </div>
  );
