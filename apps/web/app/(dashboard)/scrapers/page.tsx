    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-slate-500 mt-2 text-lg">
          Manage and monitor high-frequency market data ingestion pipelines.
        </p>
      </div>
              ...
              <tbody className="divide-y divide-slate-800/50">
                {isLoading
                  ...
                  : (runs || []).map((run: any) => (
                      ...
                      >
                        <td className="px-8 py-6 font-bold text-white uppercase">
                          {run.market}
                        </td>
                        ...
                        <td className="px-8 py-6 font-mono text-sm text-slate-400">
                          {run.rows_inserted} / {run.rows_scraped}
                        </td>
                        <td className="px-8 py-6 text-slate-500 text-sm">
                          {formatDate(run.started_at)}
                        </td>
                        <td className="px-8 py-6 text-slate-500 text-sm font-mono">
